				...
				<aside class="main-wigets">
					<div class="ads_wiget">
						...
						<a class="ads_wiget__box" href="#">
							<img src="<?php bloginfo('template_url'); ?>/pics/pic-1.jpg" alt="">
						...
						<a class="ads_wiget__box" href="#">
							<img src="<?php bloginfo('template_url'); ?>/pics/pic-2.jpg" alt="">
							<p class="ads_wiget-date">
								<span>
									24.02.2018
								</span>
						...
						<a class="ads_wiget__box" href="#">
							<img src="<?php bloginfo('template_url'); ?>/pics/pic-3.jpg" alt="">
							<p class="ads_wiget-date">
								<span>
									24.02.2018
								</span>
						...
						<a class="ads_wiget__box" href="#">
							<img src="<?php bloginfo('template_url'); ?>/pics/pic-4.jpg" alt="">
							<p class="ads_wiget-date">
								<span>
									24.02.2018
								</span>
						...
						<div class="news-box">
							...
							<a href="" class="new-box">
								<p class="new-box_time">
									24.02.2018<span>22:29</span>
								</p>
								<p>
									Опубликована 1 часть статьи "Солнечная аратинга - принадлежащая солнцу" Романа Попова
								</p>
							</a>
							<a href="" class="new-box">
								<p class="new-box_time">
