...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'cyr3lat', // The plugin name.
			'slug'               => 'cyr3lat', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/cyr3lat.zip', // The plugin source.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/advanced-custom-fields.4.4.11.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
